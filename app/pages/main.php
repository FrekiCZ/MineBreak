...
class Page {
	...
	private function setContentToArticle($article_id, $up_title, $head_title, $icon_ID, $prev_image_ID, $content) {
		...
		return str_replace(array("{MB_PAGE_ARTICLE_ID}", "{MB_PAGE_ARTICLE_UP_TITLE}", "{MB_PAGE_ARTICLE_HEAD_TITLE}", "{MB_PAGE_ARTICLE_ICON}", "{MB_PAGE_ARTICLE_PREW_IMAGE}", "{MB_PAGE_ARTICLE_CONTENT}", "{MB_ARTICLE_LINK_TITLE}"), array($article_id, $up_title, $head_title, $icon_file_name, $prew_image_name, $content, $this->remove_accents($prev_link_ac_name)), $data_content);
	}
